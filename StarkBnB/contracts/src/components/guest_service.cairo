...
/// TODO: Change the name of this componet and the file containing it. Then resolve the whole
/// codebase
#[starknet::component]
pub mod GuestHandlerComponent {
    ...
    > of IGuestHandler<ComponentState<TContractState>> {
        fn vote_service(
            ref self: ComponentState<TContractState>, service_id: felt252, direction: bool,
        ) {
        ...
        fn get_ranked_services(
            self: @ComponentState<TContractState>, direction: bool,
        ) -> Array<felt252> {
        ...
        fn set_access_list(
            ref self: ComponentState<TContractState>, service_id: felt252, blacklist: bool,
        ) {// white or black
        ...
        // to false
        // at the end of the day, a staking pool is opened, and if the set_amount is reached, a
        // default poll is created for the voting. The winner lives, the loser dies.

        // initialize poll from here, or from transactions
        // but make sure you put in the PollType

        // AT THE END OF THE DAY, CHECK THE HOST'S ADDRESS_LIST BOOL VALUE IN IT'S STORAGE AND SET
        // TO TRUE
